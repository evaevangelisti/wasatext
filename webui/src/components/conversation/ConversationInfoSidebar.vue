        ...
        <template v-else-if="conversation.type === 'group'">
            <div class="conversation-info-sidebar__content">
                ...
                <div class="group-members">
                    <span class="text-body" style="color: var(--color-tertiary)"
                        >{{ conversation.members.length }} Members</span
                    >
                    <button
...
async function leaveGroup() {
    try {
        await api.delete(
            `/groups/${props.conversation.conversationId}/members/me`,
        );
